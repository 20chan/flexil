...
namespace flexil.JIT {
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal delegate int GetMethodDefFromMethodDelegate(IntPtr thisPtr, IntPtr hMethodHandle);

	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal delegate IntPtr GetModuleAssemblyDelegate(IntPtr thisPtr, IntPtr moduleHandle);

	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal delegate IntPtr GetAssemblyNameDelegate(IntPtr thisPtr, IntPtr assemblyHandle);
